...
SocialNetwork.out: main.o  User.o Auxiliar.o
	g++ -g  -o bin/SocialNetwork.out build/main.o  build/User.o build/Auxiliar.o 
...
clean:
	rm bin/SocialNetwork.out build/main.o  build/User.o build/Auxiliar.o      
